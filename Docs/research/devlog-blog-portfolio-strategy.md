<!-- Copied verbatim from Puzzle-Generator/Docs/research/devlog-blog-portfolio-strategy.md on 2026-09-04, so the hub - which owns the portfolio and the log - holds its own copy. The framing and examples are Puzzle Lab's; the advice is the hub's. -->
