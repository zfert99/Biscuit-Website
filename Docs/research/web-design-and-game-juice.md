<!-- Copied verbatim from Puzzle-Generator/Docs/research/web-design-and-game-juice.md on 2026-09-04, so the hub - which owns the portfolio and the log - holds its own copy. The framing and examples are Puzzle Lab's; the advice is the hub's. -->
